							...
							<nav>
								<div class="nav nav-tabs" id="nav-tab" role="tablist">
									<a class="nav-item nav-link active" id="nav-all-tab"
										data-toggle="tab" href="#nav-all" role="tab">Tất cả</a> <a
										class="nav-item nav-link" id="nav-new-tab" data-toggle="tab"
										href="#nav-new" role="tab">Mới nhất</a> <a
										class="nav-item nav-link" id="nav-accessory-tab"
										data-toggle="tab" href="#nav-accessory" role="tab">Phụ
										kiện</a>
								</div>
							</nav>
						</div>
								...
								<div class="col-xl-4 col-lg-4 col-md-6">
									<div class="single-product mb-60">
										<div class="product-img">
											...
											<div class="cart">
												<a href="add-to-cart?productId=${product.productId}"> <i
													class="ti-shopping-cart"></i> Thêm vào giỏ
												</a>
											</div>
										</div>
										<div class="product-caption">
											...
											<div class="price">
												<ul>
													<li><fmt:formatNumber value="${product.productCost}"
															type="number" groupingUsed="true" />đ</li>
												</ul>
											</div>
										</div>
									</div>
