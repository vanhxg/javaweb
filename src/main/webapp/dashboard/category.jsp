...
<body>
					...
					<div class="card">
						<div class="card-body">
								...
								<tbody>
									<c:forEach var="category" items="${listCategory}">
										<tr>
											...
											<td><input type="text" class="editable-category"
							...
							<div id="successToast"
								...
								<div class="d-flex">
									<div class="toast-body">✅ Đã cập nhật danh mục thành
										công!</div>
									<button type="button"
										...
										<form action="addCategory" method="post">
											...
											<div class="modal-body px-4 pt-4">
												<div class="row g-3">
													<!-- Nhập tên danh mục -->
													<div class="col-md-12">
														<label for="categoryName" class="form-label">Tên
															danh mục</label>
											...
											<div class="modal-body px-4 pt-4">
												<div class="row g-3">
													...
													<div class="col-md-12">
														...
														<div class="input-group">
															<span class="input-group-text"><i
																class="ri-price-tag-3-line"></i></span> <input type="text"
										...
										<form action="deleteCategory" method="post"
											...
											<div class="modal-header bg-danger text-white rounded-top-4">
												<h5 class="modal-title" id="deleteCategoryModalLabel">
													<i class="ri-delete-bin-line me-2"></i>Xác nhận xóa danh
													mục
												</h5>
												<button type="button" class="btn-close btn-close-white"
													data-bs-dismiss="modal" aria-label="Đóng"></button>
							...
							<div class="modal fade" id="categoryMessageModal" tabindex="-1"
								aria-labelledby="categoryMessageModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header bg-success text-white">
											<h5 class="modal-title" id="categoryMessageModalLabel">Thông
												báo</h5>
											<button type="button" class="btn-close btn-close-white"
												data-bs-dismiss="modal" aria-label="Đóng"></button>
										</div>
	...
	<!-- JS cho cập nhật Danh Mục qua input -->
	<script>
window.addEventListener("DOMContentLoaded", function () {
    // Lặp qua tất cả các input danh mục
    document.querySelectorAll(".editable-category").forEach(function (input) {

        // Lưu giá trị cũ khi bắt đầu chỉnh sửa
        ...
        input.addEventListener("blur", function () {
            ...
            const categoryId = row.children[0].innerText.trim();
            ...
            // Nếu không có thay đổi gì thì không gửi
            if (newName === input.dataset.prevValue) return;
            ...
            fetch("editCategory", {
                ...
                body: "action=edit&categoryId=" + encodeURIComponent(categoryId) + "&categoryName=" + encodeURIComponent(newName)
     })
            .then(response => {
                if (!response.ok) throw new Error("Lỗi khi gửi dữ liệu lên server");
